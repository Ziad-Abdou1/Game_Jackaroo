...
public class PlayerViews extends StackPane {
	...
	public void draw() {
		...
		StackPane.setMargin(playerViews.get(0), new Insets(0,
				screenWidth * 0.3, 0, 0));
		StackPane.setMargin(playerViews.get(1), new Insets(0, 0,
				screenWidth * 0.3, 0));
		StackPane.setMargin(playerViews.get(2), new Insets(0, 0, 0,
				screenWidth * 0.3));
		StackPane.setMargin(playerViews.get(3), new Insets(screenWidth * 0.3,
				0, 0, 0));
