...
public class Marble {
    ...
    public Marble(Colour colour) {
        ...
        if(colour == Colour.BLUE)   circle = createMarble(Color.BLUE); 
        if(colour == Colour.GREEN)  circle = createMarble(Color.GREEN);
        if(colour == Colour.RED)  circle = createMarble(Color.RED);
        if(colour == Colour.YELLOW)  circle = createMarble(Color.web("#B8860B"));
